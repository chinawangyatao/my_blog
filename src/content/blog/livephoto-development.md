---
title: "LivePhoto开发，你要知道的知识点"
pubDate: 2018-07-09
description: "介绍 Live Photo 的开发知识点，涵盖 iOS、Web 和 Android 三平台的 Live Photo 展示方案，包括 PHAssetResource 获取源文件、PHLivePhotoView 展示、LivePhotosKit JS 网页播放等内容。"
author: wxc
...
- 对于Web用户，可以直接使用Apple官方提供的[LivePhotosKit JS](https://developer.apple.com/documentation/livephotoskitjs)，按照其使用方法将图片和视频加载到DOM元素中展示。Apple也提供了官方的一个Web展示Live Photo的Demo，点击[这里](https://developer.apple.com/live-photos/)查看。
...
![Demo页面展示](/images/livephoto-dev/demo.png)
...
![PHAssetResource解释](/images/livephoto-dev/phassetresource.png)
