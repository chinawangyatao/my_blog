...
源码【--->c30/d2/paint/gesture_paint_preview.dart<---】
...
> 源码【--->c30/d2/paint/bezier_calculate_preview.dart<---】
...
> 源码【--->c30/d2/paint/bezier_animate.dart<---】
...
> 源码【--->c30/d2/paint/gesture_x_bezier_preview.dart<---】
...
> 源码【--->c30/d2/paint/ball_wave_progress.dart<---】
...
原理图如下【--->c30/d2/paint/bezier_calculate_preview.dart<---】：
...
详细源码【--->c30/d4/text/text_paint_anim_preview.dart<---】，接着讲下各自的核心实现思路~
...
> 源码【--->c30/d4/text/text_px_paint_preview.dart<---】效果：
...
😶 前阵子公司项目用到的 **曲线图**，组里另一个小伙伴写了，但并没有很好地还原UI给出的设计稿，估计是对绘制相关的API还不是很熟悉吧，😄 这里简单写下，也是挺好的练手案例，源码【--->c30/d4/chart/line_chart.dart<---】拆解下实现步骤：
...
🤔 **弗罗伦斯·南丁格尔** 在克里米亚战争期间发明的图表，用以反映军医院的季节性死亡率，促进了医院条件的改良，外观很像饼图，但本质上更像 **极坐标下绘制的柱状图 (圆形直方图)** ，通过圆弧的半径长短反映数值大小。半径和面积间是平方关系，所以视觉上，这种图会将数据的比例夸大。浅浅写个简单例子，源码【--->c30/d4/chart/rose_chart.dart<---】：
...
😶 这个没啥，就是找接口，抠数据然后连线，数据源：数据源：[DataV.GeoAtlas 地理小工具](https://datav.aliyun.com/tools/atlas)-[JSON API](https://geo.datav.aliyun.com/areas_v3/bound/100000_full.json)，源码【--->c30/d4/chart/map_chart.dart<---】
...
😶 当初 **Android自定义View高级特效的经典案例**，大部分老玩家应该见过，用Flutter简单实现下【--->c30/d4/other/flower_loading.dart<---】可以将效果拆解成三个部分：
...
> 源码：【--->c30/d4/other/simple_clock.dart.dart<---】
