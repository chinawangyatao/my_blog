...
没啥复杂，就是 **重写关注手势对应的回调方法**，写个不同手势行为打印日志的代码示例【--->[c34/gesture\_detector\_demo.dart](https://github.com/配套示例源码/blob/master/lib/c34/gesture_detector_demo.dart)<---】，运行效果：
...
😄 还是非常简单的，完整源码【--->[c34/multiple\_tap\_gesture\_demo.dart](https://github.com/配套示例源码/blob/master/lib/c34/multiple_tap_gesture_demo.dart)<---】
